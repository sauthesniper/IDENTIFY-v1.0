...
<div class="main">
  <p style="margin-left:180px;font-color:#0066FF; font-size:  35px; text-align:center "> Adaugare cod pin </p>
<div class="addform" style="width: 25vw; margin-left:180px">
  <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    <tr><td align="right">Descriere :</td><td align="left"><input type="text" name="descriere" value="<?php echo $descriere;?>"><span class="error"> * <?php echo $edescriere;?></span></td></tr>    
     </table>  <a href="https://youlearninfo.ro/thankyoupin.html"> <button type="submit" name="submit" style="width:20vw; margin-left: 180px; align-self: center"> Adaugare cod pin</button> </a>
     <p><?php echo $mesajadd; ?></p>
</div>
  ...
  <?php
        ...
        $password = "IDentify2005"; 
        $conn = mysqli_connect($servername, $username, $password, $dbname);
    $sql= "SELECT id,value,valid,description,time from pins";
    ...
    if ($result->num_rows>0)
    {
      while ($row=$result->fetch_assoc())
      {
        ...
        echo "<tr><td style=\"text-align: center; witdth: 30%;\">" .$row["time"] ."</td><td style=\"text-align: center;\">";
          if ($row["valid"]==1) echo "<span>&#10004;</span>";
            else echo "<span>&#10006;</span>";
        echo "</td><td>" .$row["description"]."</td><td style=\"text-align: center;\">" .$row["value"]."</td></tr>";
      } echo "</table>";
    }
  ...
  <p style="margin-left:180px;font-color:#0066FF; font-size:  35px; text-align:center "> Invalidare cod pin </p>
<div class="invform" style="width: 25vw; margin-left:180px">
  <form method="post">
     <table style="text-align: center;">
    <tr><td align="left">Valoare : <input type="text" name="valinval" id="valinval" value="<?php echo $valinval;?>"> <span class="error"> * <?php echo $evalinval;?></span> 
     <button type="submit" name="submit" style="width:20vw; margin-left: 180px; align-self: center"> Invalidare cod pin</button></td></tr> </table> 
   </form>
<?php
if(array_key_exists('valinval',$_POST)){
      $data=$_POST["valinval"];
      $servername = "localhost";
      $dbname = "youlear1_DB"; 
      $username = "youlear1_admin_user"; 
      $password = "IDentify2005";
      $conn = mysqli_connect($servername, $username, $password, $dbname);
      $sql= "UPDATE pins SET valid='0' WHERE value='$data';";
      $conn->query($sql);
}
